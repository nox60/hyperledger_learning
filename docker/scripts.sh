...
-c mychannel \
-f /opt/channel-artifacts/Org1MSPanchors.tx \
--tls true \
--cafile /opt/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
